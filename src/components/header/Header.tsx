...
const Header: React.FC = () => {
    ...
    return (
        <>
            <nav className="navbar px-5 navbar-expand-lg bg-body-tertiary fixed-top">
                <div className="container-fluid">
                    ...
                    <div className="offcanvas offcanvas-start" id="offcanvasNavbar"
                        ...
                        <div className="offcanvas-header">
                            <h5 className="offcanvas-title" id="offcanvasNavbarLabel">WOMAZING</h5>
                            <button type="button" className="btn-close" data-bs-dismiss="offcanvas"
                                    aria-label="Close"></button>
                        </div>
                        <div className="offcanvas-body">

                            <div className=' container flex-column flex-lg-row align-items-center d-flex justify-content-between'>

                                <div className={`d-flex flex-column flex-lg-row mx-auto ${styles.menu}`}>
            ...
            {/*<div className=' px-5 pt-5 container d-flex justify-content-between'>*/}
