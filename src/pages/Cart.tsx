...
import {selectItems, selectTotal} from "../redux/slices/cart/selectors";
...
const Cart: React.FC = () => {
    ...
    return (
        <>
            <Header/>
            <div className={`container px-5 pt-5  ${styles.root}`}>
                ...
                <div className={` ${styles.execution}`}>
                    <div
                        className='my-5 d-flex justify-content-md-between flex-column flex-md-row gap-3 align-items-center align-items-md-none'>
                        <div className='d-flex align-items-end flex-md-row flex-column gap-4'>
                            <input className='form-control' placeholder='Введите купон'/>
                            <button type='button' className={` btn btn-outline-success ${styles.button}`}>Применить
                                купон
                            </button>
                        </div>
                        <div>
                            <button type='button' className={`btn btn-outline-success ${styles.button}`}>Обновить
                                корзину
                            </button>
                        </div>
                    </div>
                    <div
                        className={`mb-5 mx-5 d-flex align-items-center gap-2 justify-content-md-end flex-md-row flex-column ${styles.total}`}>
